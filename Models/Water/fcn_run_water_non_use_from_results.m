function water_non_use_table = fcn_run_water_non_use_from_results(cell_info, elm_option_string, elm_ha_option, water_non_use_results, water_non_use_cell2sbsn, non_use_proportion)
    ...
    [cell2sbsn_ind, cell2sbsn_idx] = ismember(water_non_use_cell2sbsn.src_id, water_non_use_results_option.src_id); 
    ...
    % Flooding q5
    chgq5_20_perha = water_non_use_results_option.chgq5_20 ./ water_non_use_results_option.hectares;
    chgq5_30_perha = water_non_use_results_option.chgq5_20 ./ water_non_use_results_option.hectares;
    chgq5_40_perha = water_non_use_results_option.chgq5_20 ./ water_non_use_results_option.hectares;
    chgq5_50_perha = water_non_use_results_option.chgq5_20 ./ water_non_use_results_option.hectares;
