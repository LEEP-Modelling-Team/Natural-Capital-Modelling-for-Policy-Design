function [es_water, es_water_flood] = fcn_run_water_elms(water_data_folder, PV, out, input_sbsn, baserun_ind, bsnrun_ind, land_cover_sbsn)

    % Limits land cover changes to inputted land_cover_sbsn
    ...
    % Extract row with src_id = land_cover_sbsn
    NEVO_base_lcs_sbsn_cells = NEVO_base_lcs_sbsn_cells(ismember(NEVO_base_lcs_sbsn_cells.src_id, land_cover_sbsn), :);
    ...
    NEVO_chg_lcs_sbsn_cells = (NEVO_new_lcs_cells(:, 2:end) .* NEVO_base_lcs_sbsn_cells.pct_cell) - table2array(NEVO_base_lcs_sbsn_cells(:,4:end));
        ...
        for j = 1:ndecades
            ...
            for k = 1:SWATemdata.nfirstorder
                ...
                if bsni_sbsn_chg_ind(sbsn_order_idx) == 1
                   ...
                   [sbsn_em_output, bsn_em_data{sbsn_order_idx}] = fcn_emulator_firstorder(SWATemdata, bsni_decj_new_lcs_sbsn(sbsn_order_idx, 3:end), sbsn_order_idx, decade_str, NEVO_water_data.cnutrient_adjustment_table);
                ...
                for k = 1:SWATemdata.nsecondorder
                    ...
                    if length(SWATemdata.secondorder{k}) == 3
                        ...
                        if (bsni_sbsn_chg_ind(sbsn_order_idx) == 1) || ...
                           ...
                           % UPDATE SWATemdata IN * OUT For this subbbasin
                           [sbsn_em_output, bsn_em_data{sbsn_order_idx}] = fcn_emulator_secondorder(SWATemdata, bsni_decj_new_lcs_sbsn(sbsn_order_idx,3:end), sbsn_order_idx, decade_str, sbsn_em_fromupstream, NEVO_water_data.cnutrient_adjustment_table);
