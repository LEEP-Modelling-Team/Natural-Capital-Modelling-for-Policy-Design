...
% Rescale quantities
% [env_outs, es_outs, sd_env_out, sd_es_out] = rescale_quantities(env_outs, es_outs, available_elm_options, 1);
...
for i = 1:nsim
    ...
    % -----------------------------------
    tic
%     switch payment_mechanism_i
%         case {'fr_env', 'fr_es'}
            warm_start_prices = fcn_run_price_search(payment_mechanism_i, ...
                                          budget_i, ...
                                          markup, ...
