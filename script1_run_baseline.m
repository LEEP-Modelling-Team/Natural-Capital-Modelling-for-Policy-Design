...
% Get carbon prices
% -----------------
% Choose carbon price using carbon_price_string
...
if MP.run_biodiversity_jncc
    es_biodiversity_jncc = fcn_run_biodiversity_jncc(MP.biodiversity_jncc_data_folder, ...
                                                     PV, ...
                                                     out);
end
...
if MP.run_biodiversity_ucl
    es_biodiversity_ucl = fcn_run_biodiversity_ucl(MP.biodiversity_ucl_data_folder, ...
                                                   out, ...
                                                   'rcp60', ...
                                                   'baseline');
end
...
save(['Script 1 (Baseline Runs)/baseline_results_', carbon_price_string, '.mat'], 'baseline');
