function water_quality_table = fcn_run_water_quality_from_results(cell_info, elm_option_string, elm_ha_option, water_quality_results, water_quality_cell2sbsn)
    ...
    [cell2sbsn_ind, cell2sbsn_idx] = ismember(water_quality_cell2sbsn.src_id, water_quality_results_option.src_id); 
    ...
    totn_ann_20_perha = water_quality_results_option.totn_ann_20 ./ water_quality_results_option.hectares;
    totn_ann_30_perha = water_quality_results_option.totn_ann_30 ./ water_quality_results_option.hectares;
    totn_ann_40_perha = water_quality_results_option.totn_ann_40 ./ water_quality_results_option.hectares;
    totn_ann_50_perha = water_quality_results_option.totn_ann_50 ./ water_quality_results_option.hectares;
    totp_ann_20_perha = water_quality_results_option.totp_ann_20 ./ water_quality_results_option.hectares;
    totp_ann_30_perha = water_quality_results_option.totp_ann_30 ./ water_quality_results_option.hectares;
    totp_ann_40_perha = water_quality_results_option.totp_ann_40 ./ water_quality_results_option.hectares;
    totp_ann_50_perha = water_quality_results_option.totp_ann_50 ./ water_quality_results_option.hectares;
