function benefit_poll_nonuse_npv = fcn_calc_npv_pollination_non_use(MP, elm_option, es_non_use_pollination_all)
    ...
    if contains(elm_option, 'arable')
        ...
        NEV_poll_nonuse_option_wood = [repmat(es_non_use_pollination_all.destocking_reversion_wood_access.wtp_change_20, 1, 10) ...
                                       repmat(es_non_use_pollination_all.destocking_reversion_wood_access.wtp_change_30, 1, 10) ...
                                       repmat(es_non_use_pollination_all.destocking_reversion_wood_access.wtp_change_40, 1, 10) ...
                                       repmat(es_non_use_pollination_all.destocking_reversion_wood_access.wtp_change_50, 1, 10)];        
        NEV_poll_nonuse_option_sng  = [repmat(es_non_use_pollination_all.destocking_reversion_sng_access.wtp_change_20, 1, 10) ...
                                       repmat(es_non_use_pollination_all.destocking_reversion_sng_access.wtp_change_30, 1, 10) ...
                                       repmat(es_non_use_pollination_all.destocking_reversion_sng_access.wtp_change_40, 1, 10) ...
                                       repmat(es_non_use_pollination_all.destocking_reversion_sng_access.wtp_change_50, 1, 10)];   
    end
