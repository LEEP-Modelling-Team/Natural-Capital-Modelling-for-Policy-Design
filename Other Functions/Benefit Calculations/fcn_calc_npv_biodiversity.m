function benefit_biodiversity_npv = fcn_calc_npv_biodiversity(MP, elm_option, es_biodiversity_jncc_all, baseline, biodiversity_unit_value)
    ...
    if contains(elm_option, 'arable')
        ...
        NEV_biodiversity_option_wood = [repmat(biodiversity_unit_value*(es_biodiversity_jncc_all.destocking_wood_access.sr_100_20 - baseline.es_biodiversity_jncc.sr_100_20), 1, 10) ...
                                        repmat(biodiversity_unit_value*(es_biodiversity_jncc_all.destocking_wood_access.sr_100_30 - baseline.es_biodiversity_jncc.sr_100_30), 1, 10) ...
                                        repmat(biodiversity_unit_value*(es_biodiversity_jncc_all.destocking_wood_access.sr_100_40 - baseline.es_biodiversity_jncc.sr_100_40), 1, 10) ...
                                        repmat(biodiversity_unit_value*(es_biodiversity_jncc_all.destocking_wood_access.sr_100_50 - baseline.es_biodiversity_jncc.sr_100_50), 1, 10)];        
        NEV_biodiversity_option_sng  = [repmat(biodiversity_unit_value*(es_biodiversity_jncc_all.destocking_sng_access.sr_100_20  - baseline.es_biodiversity_jncc.sr_100_20), 1, 10) ...
                                        repmat(biodiversity_unit_value*(es_biodiversity_jncc_all.destocking_sng_access.sr_100_30  - baseline.es_biodiversity_jncc.sr_100_30), 1, 10) ...
                                        repmat(biodiversity_unit_value*(es_biodiversity_jncc_all.destocking_sng_access.sr_100_40  - baseline.es_biodiversity_jncc.sr_100_40), 1, 10) ...
                                        repmat(biodiversity_unit_value*(es_biodiversity_jncc_all.destocking_sng_access.sr_100_50  - baseline.es_biodiversity_jncc.sr_100_50), 1, 10)];   
    end
