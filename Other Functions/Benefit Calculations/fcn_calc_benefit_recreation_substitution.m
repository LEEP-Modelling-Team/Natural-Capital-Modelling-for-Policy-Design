function benefit_rec_ann = fcn_calc_benefit_recreation_substitution(MP, start_year, elm_option, scheme_length, discount_constants, out)
    ...
    switch elm_option
        case {'arable_reversion_sng_access', 'destocking_sng_access', 'arable_reversion_sng_noaccess', 'destocking_sng_noaccess'}
            save([MP.data_out 'Recreation/rec_val_ts_' elm_option '.mat'], 'rec_val_scenario');
        case {'arable_reversion_wood_access', 'destocking_wood_access', 'arable_reversion_wood_noaccess', 'destocking_wood_noaccess'}
            if strcmp(elm_option, 'arable_reversion_wood_access')
                rec_val_grass = load([MP.data_out 'Recreation/rec_val_ts_arable_reversion_sng_access.mat']);
            elseif strcmp(elm_option, 'destocking_wood_access')
                rec_val_grass = load([MP.data_out 'Recreation/rec_val_ts_destocking_sng_access.mat']);
            elseif strcmp(elm_option, 'arable_reversion_wood_noaccess')
                rec_val_grass = load([MP.data_out 'Recreation/rec_val_ts_arable_reversion_sng_noaccess.mat']);
            elseif strcmp(elm_option, 'destocking_wood_noaccess')
                rec_val_grass = load([MP.data_out 'Recreation/rec_val_ts_destocking_sng_noaccess.mat']);
            end
    ...
    baseline.rec_val = zeros(size(rec_val_scenario));
