function benefit_wnonuse_npv = fcn_calc_npv_water_non_use(MP, elm_option, es_wnonuse_all)
    ...
    if contains(elm_option, 'arable')
        ...
        NEV_wnonuse_option_wood = [repmat(es_wnonuse_all.destocking_reversion_wood_access.non_use_value_20, 1, 10) ...
                                   repmat(es_wnonuse_all.destocking_reversion_wood_access.non_use_value_30, 1, 10) ...
                                   repmat(es_wnonuse_all.destocking_reversion_wood_access.non_use_value_40, 1, 10) ...
                                   repmat(es_wnonuse_all.destocking_reversion_wood_access.non_use_value_50, 1, 10)];        
        NEV_wnonuse_option_sng  = [repmat(es_wnonuse_all.destocking_reversion_sng_access.non_use_value_20, 1, 10) ...
                                   repmat(es_wnonuse_all.destocking_reversion_sng_access.non_use_value_30, 1, 10) ...
                                   repmat(es_wnonuse_all.destocking_reversion_sng_access.non_use_value_40, 1, 10) ...
                                   repmat(es_wnonuse_all.destocking_reversion_sng_access.non_use_value_50, 1, 10)];   
    end
